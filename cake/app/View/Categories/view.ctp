	...
	<?php foreach ($category['Subcategory'] as $subcategory): ?>
		<tr>
			...
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'subcategories', 'action' => 'delete', $subcategory['id']), array('confirm' => __('Are you sure you want to delete # %s?', $subcategory['id']))); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
