<div class="subcategories index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $subcategory['Subcategory']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $subcategory['Subcategory']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
